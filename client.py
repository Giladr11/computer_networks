...
COMMANDS_HELP_INFO = (f"{Fore.LIGHTYELLOW_EX}The Commands you can use are:\n"
                      f"1. {COMMANDS_LIST[0]}  __full_directory's_url__\n"
                      f"2. {COMMANDS_LIST[1]}  __full_file's_url_\n"
                      f"3. {COMMANDS_LIST[2]}  __full_file's_url___full_file's_url__\n"
                      f"4. {COMMANDS_LIST[3]}  __app's_url__\n"
                      f"5. {COMMANDS_LIST[4]}  __full_file's_url_to_save_at__\n"
                      f"6. {COMMANDS_LIST[5]}  __full_file's_url__to_save_at_{Fore.RESET}")
...
class Client:
    def __init__(self):
        ...
        print(self.client.recv(WELCOME_MESSAGE_SIZE).decode('utf-8'))
        self.message = ""
    ...
    def send_message(self):
        self.client.send(str(len(self.message)).encode('utf-8'))
    ...
    def receive_messages(self):
        ...
        try:
            message_size = self.client.recv(HEADER_SIZE).decode('utf-8')
